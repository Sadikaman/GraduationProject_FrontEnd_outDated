    ...
    <>
      <section className='flex flex-col pt-20 md:pt-36 dark:bg-gray-900 dark:text-white'>
        ...
        <div className='flex flex-col items-center w-full mt-10 md:mt-20'>
          <div className='flex flex-col md:flex-row gap-4 md:gap-10 w-[70%] xl:w-[70%] md:w-[80%] '>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <p className='text-black text-base md:text-2xl font-normal text-start dark:text-white'>
          ...
          <div className='flex flex-col md:flex-row gap-4 md:gap-10 w-[70%] xl:[70%] md:w-[80%] mt-10 md:mt-20'>
            <div className='flex flex-col gap-3'>
              <h1 className='text-2xl md:text-4xl font-bold text-[#2986FE] text-center md:text-left'>
                Our Mission
              </h1>
