          ...
          <ul className="space-y-2 font-medium flex flex-col justify-center items-center mt-7 gap-4">
            <li>
              <a
                ...
                className="flex justify-center p-2 rounded-full w-52 text-gray-900 items-center bg-white shadow-sm gap-5 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  className="w-5 h-5 text-blue-500 transition duration-75 dark:text-gray-400 group-hover:text-blue-700 dark:group-hover:text-white"
                  aria-hidden="true"
