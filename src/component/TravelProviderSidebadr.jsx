...
<div className='flex gap-1 w-full mt-5'>
    ...
    <ul className="space-y-2 font-medium flex flex-col justify-center items-center mt-10 gap-4">
      <li>
        <a href="#" className="flex justify-center  p-2 rounded-full w-52  text-gray-900 rounded-lgitems-center bg-white shadow-sm gap-5  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<h1 className='pt-5 text-gray-500 font-semibold'>BUSINESS SETTINGS</h1>
      ...
      <li>
        <a href="/Packagess" className="flex items-center font-bold gap-4 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
