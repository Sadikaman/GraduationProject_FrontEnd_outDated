...
const BookTicket = (isDarkMode, toggleDarkMode) => {
  ...
  'use client';
  return (
    <section className=' flex pt-10 justify-center dark:bg-gray-900 dark:text-white' id='Education'>
...
<div>
    <Card className="max-w-sm h-[420px] w-96 rounded-b-none bg-black text-white rounded-t-3xl ">
